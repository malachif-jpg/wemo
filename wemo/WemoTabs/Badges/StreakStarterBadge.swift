...
struct StreakStarterBadge: View {
    var body: some View {
        NavigationStack{
            ZStack{
                VStack{
                    ...
                    Text("Streak Starter Badge")
                        .font(.title2)
                        .bold()
                    Spacer().frame(height: 20)
                    Text("For lighting the spark — 7 days of continuous journaling. Your journey begins here!").multilineTextAlignment(.center)
                    Spacer()
                    Button(action: {
